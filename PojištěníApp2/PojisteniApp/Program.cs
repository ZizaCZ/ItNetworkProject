    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            using (var scope = app.Services.CreateScope())
            {
                ...
                spravceRoli.CreateAsync(new IdentityRole("customer")).Wait();
                IdentityUser uzivatel = spravceUzivatelu.FindByEmailAsync("UserTestRole@seznam.cz").Result;
                spravceUzivatelu.AddToRoleAsync(uzivatel, "customer").Wait();
            }
